...
import com.bot.ncl.adapter.event.app.evt.TF001_SVC_CLDTL;
...
@Slf4j
@Component("TF001_SVC_CLDTLLsnr")
@Scope("prototype")
public class TF001_SVC_CLDTLLsnr extends BatchListenerCase<TF001_SVC_CLDTL> {
    ...
    @Override
    public void onApplicationEvent(TF001_SVC_CLDTL event) {
    ...
    @Override
    @SneakyThrows
    protected void run(TF001_SVC_CLDTL event) {
    ...
    private void initParams(TF001_SVC_CLDTL event) {
