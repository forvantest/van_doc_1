...
@Component("CONVCLCMP2.I")
@Scope("prototype")
public class CONVCLCMP2__I extends RequestBaseSvc implements RequestSvcCase {
    private RequestLabel label;

    @CustomSchema(
            order = 68,
            schema = @Schema(description = "檔案名稱", maxLength = 10, type = "CHAR"),
            align = "LEFT",
            pad = "SPACE")
    @NotEmpty(message = "{FILENAME}")
