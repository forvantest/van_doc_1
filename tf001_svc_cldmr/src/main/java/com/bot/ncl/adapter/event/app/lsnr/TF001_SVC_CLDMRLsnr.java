...
import com.bot.ncl.adapter.event.app.evt.TF001_SVC_CLDMR;
...
@Slf4j
@Component("TF001_SVC_CLDMRLsnr")
@Scope("prototype")
public class TF001_SVC_CLDMRLsnr extends BatchListenerCase<TF001_SVC_CLDMR> {
    ...
    @Override
    public void onApplicationEvent(TF001_SVC_CLDMR event) {
    ...
    @Override
    @SneakyThrows
    protected void run(TF001_SVC_CLDMR event) {
    ...
    private void initParams(TF001_SVC_CLDMR event) {
