...
import com.bot.ncl.adapter.event.app.evt.TF001_SVC_CLFEE;
...
@Slf4j
@Component("TF001_SVC_CLFEELsnr")
@Scope("prototype")
public class TF001_SVC_CLFEELsnr extends BatchListenerCase<TF001_SVC_CLFEE> {
    ...
    @Override
    public void onApplicationEvent(TF001_SVC_CLFEE event) {
    ...
    @Override
    @SneakyThrows
    protected void run(TF001_SVC_CLFEE event) {
    ...
    private void initParams(TF001_SVC_CLFEE event) {
