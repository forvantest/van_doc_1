...
import com.bot.ncl.adapter.event.app.evt.TF001_SVC_CLTMR;
...
@Slf4j
@Component("TF001_SVC_CLTMRLsnr")
@Scope("prototype")
public class TF001_SVC_CLTMRLsnr extends BatchListenerCase<TF001_SVC_CLTMR> {
    ...
    @Override
    public void onApplicationEvent(TF001_SVC_CLTMR event) {
    ...
    @Override
    @SneakyThrows
    protected void run(TF001_SVC_CLTMR event) {
    ...
    private void initParams(TF001_SVC_CLTMR event) {
