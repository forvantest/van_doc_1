...
import com.bot.ncl.adapter.event.app.evt.TF001_SVC_CLCMP;
...
@Slf4j
@Component("TF001_SVC_CLCMPLsnr")
@Scope("prototype")
public class TF001_SVC_CLCMPLsnr extends BatchListenerCase<TF001_SVC_CLCMP> {
    ...
    @Override
    public void onApplicationEvent(TF001_SVC_CLCMP event) {
    ...
    @Override
    @SneakyThrows
    protected void run(TF001_SVC_CLCMP event) {
    ...
    private void initParams(TF001_SVC_CLCMP event) {
