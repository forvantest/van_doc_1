...
import com.bot.ncl.adapter.event.app.evt.TF001_SVC_CLMC;
...
@Slf4j
@Component("TF001_SVC_CLMCLsnr")
@Scope("prototype")
public class TF001_SVC_CLMCLsnr extends BatchListenerCase<TF001_SVC_CLMC> {
    ...
    @Override
    public void onApplicationEvent(TF001_SVC_CLMC event) {
    ...
    @Override
    @SneakyThrows
    protected void run(TF001_SVC_CLMC event) {
    ...
    private void initParams(TF001_SVC_CLMC event) {
