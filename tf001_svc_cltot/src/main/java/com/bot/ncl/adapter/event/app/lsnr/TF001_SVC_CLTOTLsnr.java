...
import com.bot.ncl.adapter.event.app.evt.TF001_SVC_CLTOT;
...
@Slf4j
@Component("TF001_SVC_CLTOTLsnr")
@Scope("prototype")
public class TF001_SVC_CLTOTLsnr extends BatchListenerCase<TF001_SVC_CLTOT> {
    ...
    @Override
    public void onApplicationEvent(TF001_SVC_CLTOT event) {
    ...
    @Override
    @SneakyThrows
    protected void run(TF001_SVC_CLTOT event) {
    ...
    private void initParams(TF001_SVC_CLTOT event) {
