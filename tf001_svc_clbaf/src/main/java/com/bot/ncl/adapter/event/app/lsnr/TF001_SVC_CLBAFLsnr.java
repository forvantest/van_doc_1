...
import com.bot.ncl.adapter.event.app.evt.TF001_SVC_CLBAF;
...
@Slf4j
@Component("TF001_SVC_CLBAFLsnr")
@Scope("prototype")
public class TF001_SVC_CLBAFLsnr extends BatchListenerCase<TF001_SVC_CLBAF> {
    ...
    @Override
    public void onApplicationEvent(TF001_SVC_CLBAF event) {
    ...
    @Override
    @SneakyThrows
    protected void run(TF001_SVC_CLBAF event) {
    ...
    private void initParams(TF001_SVC_CLBAF event) {
